...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex items-center gap-3 sm:bottom-8 sm:right-8">
      {/* Tooltip label */}
      <AnimatePresence>
        {hovered && (
          <motion.div
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-shadow hover:shadow-[0_4px_32px_rgba(37,211,102,0.65)]"
      >
        {/* Ping ring */}
